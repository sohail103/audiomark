                          ...
                          const uint16_t *pBitRevTab)
{
    ...
    size_t         vl  = __riscv_vsetvl_e64m2(remaining);
    vuint16mf2x2_t seg = __riscv_vlseg2e16_v_u16mf2x2(pBitRevTab, vl);
    vuint16mf2_t   oa  = __riscv_vget_v_u16mf2x2_u16mf2(seg, 0);
    vuint16mf2_t   ob  = __riscv_vget_v_u16mf2x2_u16mf2(seg, 1);
    pBitRevTab += vl * 2;
    remaining -= vl;

    while (remaining > 0)
    {
        vuint64m2_t va = __riscv_vluxei16_v_u64m2(base, oa, vl);
        vuint64m2_t vb = __riscv_vluxei16_v_u64m2(base, ob, vl);
        __riscv_vsuxei16_v_u64m2(base, oa, vb, vl);
        __riscv_vsuxei16_v_u64m2(base, ob, va, vl);

        size_t         vl_next = __riscv_vsetvl_e64m2(remaining);
        vuint16mf2x2_t seg_next
            = __riscv_vlseg2e16_v_u16mf2x2(pBitRevTab, vl_next);
        oa = __riscv_vget_v_u16mf2x2_u16mf2(seg_next, 0);
        ob = __riscv_vget_v_u16mf2x2_u16mf2(seg_next, 1);
        pBitRevTab += vl_next * 2;
        remaining -= vl_next;
        vl = vl_next;
    }
                                   ...
                                   uint32_t                       fftLen)
{
    ...
    while (n2 > 1)
    {
        ...
        for (int i = 0; i < iter; i++)
        {
            ...
            while (blkCnt > 0)
            {
                ...
                /* Out1 = T1 * W2 */
                vfloat32m2x2_t vW2   = __riscv_vlseg2e32_v_f32m2x2(tw2, vl);
                ...
                /* Out2 = T2 * W1 */
                vfloat32m2x2_t vW1   = __riscv_vlseg2e32_v_f32m2x2(tw1, vl);
                ...
                /* Out3 = T3 * W3 */
                vfloat32m2x2_t vW3   = __riscv_vlseg2e32_v_f32m2x2(tw3, vl);
                ...
                vfloat32m2x2_t vOut0 = __riscv_vset_v_f32m2_f32m2x2(
                    __riscv_vundefined_f32m2x2(), 0, out0r);
                vOut0 = __riscv_vset_v_f32m2_f32m2x2(vOut0, 1, out0i);
                __riscv_vsseg2e32_v_f32m2x2(inA, vOut0, vl);

                vfloat32m2x2_t vOut1 = __riscv_vset_v_f32m2_f32m2x2(
                    __riscv_vundefined_f32m2x2(), 0, out1r);
                vOut1 = __riscv_vset_v_f32m2_f32m2x2(vOut1, 1, out1i);
                __riscv_vsseg2e32_v_f32m2x2(inB, vOut1, vl);

                vfloat32m2x2_t vOut2 = __riscv_vset_v_f32m2_f32m2x2(
                    __riscv_vundefined_f32m2x2(), 0, out2r);
                vOut2 = __riscv_vset_v_f32m2_f32m2x2(vOut2, 1, out2i);
                __riscv_vsseg2e32_v_f32m2x2(inC, vOut2, vl);

                vfloat32m2x2_t vOut3 = __riscv_vset_v_f32m2_f32m2x2(
                    __riscv_vundefined_f32m2x2(), 0, out3r);
                vOut3 = __riscv_vset_v_f32m2_f32m2x2(vOut3, 1, out3i);
                __riscv_vsseg2e32_v_f32m2x2(inD, vOut3, vl);
    ...
    float32_t *pBase  = pSrc;
    uint32_t   blkCnt = fftLen / 4;

    while (blkCnt > 0)
    {
        size_t vl = __riscv_vsetvl_e32m1(blkCnt);

        vfloat32m1x8_t vAll = __riscv_vlseg8e32_v_f32m1x8(pBase, vl);

        vfloat32m1_t Ar = __riscv_vget_v_f32m1x8_f32m1(vAll, 0);
        vfloat32m1_t Ai = __riscv_vget_v_f32m1x8_f32m1(vAll, 1);
        vfloat32m1_t Br = __riscv_vget_v_f32m1x8_f32m1(vAll, 2);
        vfloat32m1_t Bi = __riscv_vget_v_f32m1x8_f32m1(vAll, 3);
        vfloat32m1_t Cr = __riscv_vget_v_f32m1x8_f32m1(vAll, 4);
        vfloat32m1_t Ci = __riscv_vget_v_f32m1x8_f32m1(vAll, 5);
        vfloat32m1_t Dr = __riscv_vget_v_f32m1x8_f32m1(vAll, 6);
        vfloat32m1_t Di = __riscv_vget_v_f32m1x8_f32m1(vAll, 7);

        vfloat32m1_t Sum0r  = __riscv_vfadd_vv_f32m1(Ar, Cr, vl);
        vfloat32m1_t Sum0i  = __riscv_vfadd_vv_f32m1(Ai, Ci, vl);
        vfloat32m1_t Diff0r = __riscv_vfsub_vv_f32m1(Ar, Cr, vl);
        vfloat32m1_t Diff0i = __riscv_vfsub_vv_f32m1(Ai, Ci, vl);

        vfloat32m1_t Sum1r  = __riscv_vfadd_vv_f32m1(Br, Dr, vl);
        vfloat32m1_t Sum1i  = __riscv_vfadd_vv_f32m1(Bi, Di, vl);
        vfloat32m1_t Diff1r = __riscv_vfsub_vv_f32m1(Br, Dr, vl);
        vfloat32m1_t Diff1i = __riscv_vfsub_vv_f32m1(Bi, Di, vl);

        vfloat32m1_t out0r = __riscv_vfmul_vf_f32m1(
            __riscv_vfadd_vv_f32m1(Sum0r, Sum1r, vl), onebyfftLen, vl);
        vfloat32m1_t out0i = __riscv_vfmul_vf_f32m1(
            __riscv_vfadd_vv_f32m1(Sum0i, Sum1i, vl), onebyfftLen, vl);

        vfloat32m1_t out1r = __riscv_vfmul_vf_f32m1(
            __riscv_vfsub_vv_f32m1(Sum0r, Sum1r, vl), onebyfftLen, vl);
        vfloat32m1_t out1i = __riscv_vfmul_vf_f32m1(
            __riscv_vfsub_vv_f32m1(Sum0i, Sum1i, vl), onebyfftLen, vl);

        vfloat32m1_t out2r = __riscv_vfmul_vf_f32m1(
            __riscv_vfsub_vv_f32m1(Diff0r, Diff1i, vl), onebyfftLen, vl);
        vfloat32m1_t out2i = __riscv_vfmul_vf_f32m1(
            __riscv_vfadd_vv_f32m1(Diff0i, Diff1r, vl), onebyfftLen, vl);

        vfloat32m1_t out3r = __riscv_vfmul_vf_f32m1(
            __riscv_vfadd_vv_f32m1(Diff0r, Diff1i, vl), onebyfftLen, vl);
        vfloat32m1_t out3i = __riscv_vfmul_vf_f32m1(
            __riscv_vfsub_vv_f32m1(Diff0i, Diff1r, vl), onebyfftLen, vl);

        vfloat32m1x8_t vOut = __riscv_vundefined_f32m1x8();
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 0, out0r);
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 1, out0i);
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 2, out1r);
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 3, out1i);
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 4, out2r);
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 5, out2i);
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 6, out3r);
        vOut                = __riscv_vset_v_f32m1_f32m1x8(vOut, 7, out3i);

        __riscv_vsseg8e32_v_f32m1x8(pBase, vOut, vl);
                           ...
                           uint32_t                       fftLen)
{
    ...
    while (blkCnt > 0)
    {
        ...
        vfloat32m1_t out0r = __riscv_vfadd_vv_f32m1(Sum0r, Sum1r, vl);
        vfloat32m1_t out0i = __riscv_vfadd_vv_f32m1(Sum0i, Sum1i, vl);

        vfloat32m1_t out1r = __riscv_vfsub_vv_f32m1(Sum0r, Sum1r, vl);
        vfloat32m1_t out1i = __riscv_vfsub_vv_f32m1(Sum0i, Sum1i, vl);

        vfloat32m1_t out2r = __riscv_vfadd_vv_f32m1(Diff0r, Diff1i, vl);
        vfloat32m1_t out2i = __riscv_vfsub_vv_f32m1(Diff0i, Diff1r, vl);

        vfloat32m1_t out3r = __riscv_vfsub_vv_f32m1(Diff0r, Diff1i, vl);
        vfloat32m1_t out3i = __riscv_vfadd_vv_f32m1(Diff0i, Diff1r, vl);
                         ...
                         uint32_t                       fftLen)
{
    ...
    while (blkCnt > 0)
    {
        ...
        vfloat32m2x2_t vOut0 = __riscv_vset_v_f32m2_f32m2x2(
            __riscv_vundefined_f32m2x2(), 0, Sum_r);
        vOut0 = __riscv_vset_v_f32m2_f32m2x2(vOut0, 1, Sum_i);
        __riscv_vsseg2e32_v_f32m2x2(pIn0, vOut0, vl);

        vfloat32m2x2_t vOut1 = __riscv_vset_v_f32m2_f32m2x2(
            __riscv_vundefined_f32m2x2(), 0, CmpTmp_r);
        vOut1 = __riscv_vset_v_f32m2_f32m2x2(vOut1, 1, CmpTmp_i);
        __riscv_vsseg2e32_v_f32m2x2(pIn1, vOut1, vl);
