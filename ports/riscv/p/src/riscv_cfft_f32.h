...
void riscv_radix4_butterfly_inverse_q31(const riscv_cfft_instance_q31 *S, q31_t   *pSrc, uint32_t fftLen);

void riscv_radix4_butterfly_q31(const riscv_cfft_instance_q31 *S, q31_t   *pSrc, uint32_t fftLen);
