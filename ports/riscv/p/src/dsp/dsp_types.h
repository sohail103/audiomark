...
#define riscv_cfft_init_f32 riscv_cfft_init_q31

#define riscv_rfft_fast_init_f32 riscv_rfft_fast_init_q31
    ...
    typedef struct
    {
        ...
        const uint32_t *
            rearranged_twiddle_tab_stride3_arr; /**< Per stage reordered twiddle
                                                   pointer (offset 3) */
        const q31_t *rearranged_twiddle_stride1; /**< reordered twiddle offset 1
                                                    storage */
        const q31_t *rearranged_twiddle_stride2; /**< reordered twiddle offset 2
                                                    storage */
    ...
    typedef riscv_cfft_instance_q31 riscv_cfft_instance;

    typedef riscv_rfft_fast_instance_q31 riscv_rfft_fast_instance;
